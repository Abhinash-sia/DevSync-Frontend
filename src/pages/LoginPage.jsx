    ...
    <div className="min-h-screen bg-[#000000] text-white font-sans selection:bg-[#12b3a8]/30 selection:text-[#12b3a8]">
      <div className="grid min-h-screen xl:grid-cols-[1.1fr_0.9fr]">
        ...
        <section className="relative hidden overflow-hidden border-r border-white/[0.04] bg-[#030303] xl:block">
          {/* Subtle Ambient Glow */}
          <div className="absolute top-0 left-0 w-full h-[500px] bg-[#12b3a8]/10 blur-[120px] pointer-events-none" />
            ...
            <div>
              ...
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, ease: "circ.out" }} className="mt-20">
                ...
                <h1 className="mt-8 text-[clamp(2.5rem,4vw,4rem)] font-black leading-[0.9] tracking-tighter text-white">
                  ACCESS THE <br /> <span className="text-[#12b3a8]">NETWORK.</span>
                </h1>
                ...
                <div className="mt-12 space-y-3">
                  {terminalLines.map((line, index) => (
                    <motion.div key={line} initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.2 + index * 0.1, duration: 0.5 }} className="flex items-center gap-3">
                      <span className="font-mono text-xs text-[#12b3a8]">➜</span>
        ...
        <section className="relative flex min-h-screen items-center justify-center px-6 py-12">
          {/* Mobile Glow */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-md h-64 bg-[#12b3a8]/5 blur-[100px] xl:hidden pointer-events-none" />

          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="relative z-10 w-full max-w-[440px] rounded-[24px] border border-white/[0.06] bg-[#050505]/80 p-8 backdrop-blur-2xl shadow-2xl">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="mt-8 space-y-6">
              <div>
                ...
                <input type="email" placeholder="developer@node.com" {...register("email")} className="w-full rounded-xl border border-white/10 bg-[#0a0a0a] px-4 py-3.5 text-sm text-white placeholder:text-white/20 focus:border-[#12b3a8]/50 focus:bg-[#12b3a8]/5 focus:outline-none transition-colors" />
              ...
              <div>
                <div className="mb-2 flex items-center justify-between">
                  ...
                  <span className="font-mono text-[10px] text-[#12b3a8]">Required</span>
                </div>
                <input type="password" placeholder="••••••••" {...register("password")} className="w-full rounded-xl border border-white/10 bg-[#0a0a0a] px-4 py-3.5 text-sm text-white placeholder:text-white/20 focus:border-[#12b3a8]/50 focus:bg-[#12b3a8]/5 focus:outline-none transition-colors" />
              ...
              <button type="submit" disabled={login.isPending} className="group relative flex w-full h-12 items-center justify-center overflow-hidden rounded-xl border border-[#12b3a8]/40 bg-[#0a0a0a] transition-all hover:border-[#12b3a8] hover:bg-[#12b3a8]/10 hover:shadow-[0_0_20px_rgba(18,179,168,0.2)] disabled:opacity-50">
            ...
            <div className="mt-8 border-t border-white/[0.04] pt-6 text-center">
              <p className="font-mono text-xs text-white/30">
                Unregistered Node? <Link to="/register" className="font-bold text-[#12b3a8] hover:text-white transition-colors">Deploy Profile</Link>
              </p>
            </div>
          </motion.div>
        </section>
