...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-[#000000] text-white font-sans selection:bg-[#12b3a8]/30 selection:text-[#12b3a8]">
      <div className="grid min-h-screen xl:grid-cols-[0.9fr_1.1fr]">
        
        {/* Left Side: Branding */}
        <section className="relative hidden overflow-hidden border-r border-white/[0.04] bg-[#030303] xl:block">
          <div className="absolute top-1/2 left-0 w-full h-[600px] -translate-y-1/2 bg-[#12b3a8]/5 blur-[150px] pointer-events-none" />
          
          <div className="relative z-10 flex h-full flex-col justify-between px-12 py-12">
            <div>
              <Link to="/" className="inline-flex items-center gap-3 group">
                <div className="flex h-10 w-10 items-center justify-center rounded-xl border border-[#12b3a8]/20 bg-[#12b3a8]/10 group-hover:bg-[#12b3a8]/20 transition-colors">
                  <TerminalSquare size={16} className="text-[#12b3a8]" />
                </div>
                <div>
                  <p className="font-mono text-[10px] uppercase tracking-[0.28em] text-[#12b3a8]">DevSync</p>
              ...
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="mt-20">
                <div className="inline-flex items-center gap-2 rounded-full border border-[#12b3a8]/20 bg-[#12b3a8]/5 px-3 py-1 font-mono text-[10px] uppercase tracking-[0.2em] text-[#12b3a8]">
                ...
                <div className="mt-12 space-y-4">
                  {points.map((point, index) => (
                    <motion.div key={point} initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.2 + index * 0.1, duration: 0.5 }} className="flex items-start gap-4 rounded-xl border border-white/[0.04] bg-[#0a0a0a] p-4">
                      <div className="mt-0.5 h-2 w-2 shrink-0 rounded-full bg-[#12b3a8] shadow-[0_0_8px_rgba(18,179,168,0.8)]" />
        ...
        <section className="relative flex min-h-screen items-center justify-center px-6 py-12">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="relative z-10 w-full max-w-[500px] rounded-[24px] border border-white/[0.06] bg-[#050505]/80 p-8 backdrop-blur-2xl shadow-2xl">
            <div className="mb-10 xl:hidden">
              <Link to="/" className="inline-flex items-center gap-3">
                <TerminalSquare size={20} className="text-[#12b3a8]" />
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="mt-8 space-y-5">
              <div>
                ...
                <input {...register("name")} placeholder="System Administrator" className="w-full rounded-xl border border-white/10 bg-[#0a0a0a] px-4 py-3.5 text-sm text-white placeholder:text-white/20 focus:border-[#12b3a8]/50 focus:bg-[#12b3a8]/5 focus:outline-none transition-colors" />
              ...
              <div className="grid gap-5 md:grid-cols-2">
                <div>
                  ...
                  <input type="email" {...register("email")} placeholder="dev@node.com" className="w-full rounded-xl border border-white/10 bg-[#0a0a0a] px-4 py-3.5 text-sm text-white placeholder:text-white/20 focus:border-[#12b3a8]/50 focus:bg-[#12b3a8]/5 focus:outline-none transition-colors" />
                ...
                <div>
                  ...
                  <input type="password" {...register("password")} placeholder="••••••••" className="w-full rounded-xl border border-white/10 bg-[#0a0a0a] px-4 py-3.5 text-sm text-white placeholder:text-white/20 focus:border-[#12b3a8]/50 focus:bg-[#12b3a8]/5 focus:outline-none transition-colors" />
              ...
              <div>
                ...
                <input {...register("github")} placeholder="github.com/username" className="w-full rounded-xl border border-white/10 bg-[#0a0a0a] px-4 py-3.5 text-sm text-white placeholder:text-white/20 focus:border-[#12b3a8]/50 focus:bg-[#12b3a8]/5 focus:outline-none transition-colors" />
              </div>
              ...
              <button type="submit" disabled={registerUser.isPending} className="group relative mt-2 flex w-full h-12 items-center justify-center overflow-hidden rounded-xl border border-[#12b3a8]/40 bg-[#0a0a0a] transition-all hover:border-[#12b3a8] hover:bg-[#12b3a8]/10 hover:shadow-[0_0_20px_rgba(18,179,168,0.2)] disabled:opacity-50">
            ...
            <div className="mt-6 border-t border-white/[0.04] pt-5 text-center">
              <p className="font-mono text-xs text-white/30">
                Already registered? <Link to="/login" className="font-bold text-[#12b3a8] hover:text-white transition-colors">Initiate Login</Link>
              </p>
            </div>
          </motion.div>
        </section>
