      ...
      {lastMatch && (
        <>
          ...
          <motion.div
            ...
            className="fixed left-1/2 top-1/2 z-[60] w-[calc(100%-24px)] max-w-md -translate-x-1/2 -translate-y-1/2 overflow-hidden rounded-[30px] border border-[#12b3a8]/25 bg-[#0d1011] p-6 shadow-2xl"
          >
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(18,179,168,0.12),transparent_48%)]" />

            <div className="relative z-10">
              <div className="inline-flex rounded-full border border-[#12b3a8]/25 bg-[#12b3a8]/10 px-4 py-2 font-mono-ui text-[11px] uppercase tracking-[0.26em] text-[#9ff7ee]">
                match detected
              </div>
              ...
              <div className="mt-6 flex items-center justify-center gap-4">
                ...
                <div className="text-2xl text-[#9ff7ee]">×</div>
                <img
                  src={
