...
export default function ConnectionCard({ user }) {
  ...
  return (
    <article className="group relative overflow-hidden rounded-[24px] border border-white/[0.04] bg-[#050505] p-8 transition-colors hover:border-[#12b3a8]/30 hover:bg-[#0a0a0a]">
      ...
      <div className="relative z-10 flex items-start gap-4">
        <div className="relative">
          ...
          />
          <span className={`absolute -bottom-1 -right-1 h-3.5 w-3.5 rounded-full border-2 border-[#000000] ${
            isOnline ? "bg-[#12b3a8] shadow-[0_0_10px_rgba(18,179,168,0.8)]" : "bg-zinc-600"
          }`} />
        </div>

        <div className="min-w-0 flex-1">
          <h3 className="truncate text-lg font-bold tracking-tight text-white group-hover:text-[#12b3a8] transition-colors uppercase">
        ...
        {user?.githubUrl && (
          <a href={user.githubUrl} target="_blank" rel="noopener noreferrer"
            className="flex h-9 w-9 items-center justify-center rounded-xl border border-white/[0.04] bg-[#0a0a0a] text-white/30 transition hover:border-[#12b3a8]/50 hover:text-[#12b3a8]">
      ...
      <div className="relative z-10 mt-6 border-t border-white/[0.04] pt-5">
        ...
        <Link to={`/app/chat/${user?.roomId}`}
          className="flex items-center justify-center gap-3 rounded-xl border border-[#12b3a8]/30 bg-[#0a0a0a] px-4 py-3 transition-all hover:border-[#12b3a8] hover:bg-[#12b3a8]/10 hover:shadow-[0_0_15px_rgba(18,179,168,0.2)]">
