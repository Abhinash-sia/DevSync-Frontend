...
export default function MobileNav() {
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40 border-t border-white/[0.06] bg-[#070909]/80 pb-safe backdrop-blur-2xl xl:hidden">
              ...
              <>
                {isActive && (
                  <motion.div
                    ...
                    className="absolute inset-0 rounded-xl bg-[#12b3a8]/15 border border-[#12b3a8]/30 shadow-[0_0_15px_rgba(18,179,168,0.1)]"
                ...
                <div className={`relative z-10 flex flex-col items-center gap-1.5 px-1 py-3 text-[10px] uppercase tracking-wider font-medium transition-colors ${
                  isActive ? "text-[#9ff7ee]" : "text-white/40 hover:text-white"
                }`}>
